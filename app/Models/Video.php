...
{
	use SoftDeletes, Traits\Voteable, Traits\Orderable;
	...
	public function getThumbnail($video)
	{
		if (!$this->isProcessed()) {
			...
			return config('codetube.buckets.videos').$video;
		}
	}
	...
	public function getStreamUrl( $enc_video_id)
	{
		return config('codetube.buckets.videos') . $enc_video_id ;
	}
